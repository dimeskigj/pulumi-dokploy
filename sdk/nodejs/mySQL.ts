...
export class MySQL extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MySQL {
        return new MySQL(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dokploy:index:MySQL';
     ...
     */
    declare public /*out*/ readonly mysqlId: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, args: MySQLArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["dockerImage"] = (args?.dockerImage) ?? "mysql:8";
