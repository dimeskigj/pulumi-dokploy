...
export class MongoDB extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MongoDB {
        return new MongoDB(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'dokploy:index:MongoDB';
     ...
     */
    declare public /*out*/ readonly mongoId: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, args: MongoDBArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["dockerImage"] = (args?.dockerImage) ?? "mongo:8";
        ...
        super(MongoDB.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface MongoDBArgs {
     ...
     * Whether to enable a MongoDB replica set.
     */
    replicaSets?: pulumi.Input<boolean | undefined>;
    /**
     * The optional server ID.
     */
