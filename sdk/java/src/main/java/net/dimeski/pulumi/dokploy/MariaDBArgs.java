...
public final class MariaDBArgs extends com.pulumi.resources.ResourceArgs {

    public static final MariaDBArgs Empty = new MariaDBArgs();
    ...
    private MariaDBArgs(MariaDBArgs $) {
    ...
    public static Builder builder(MariaDBArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MariaDBArgs defaults) {
            $ = new MariaDBArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param databaseName The MariaDB database name.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param databasePassword The MariaDB database password.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param databaseRootPassword The optional MariaDB root password.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param databaseUser The MariaDB database user.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param dockerImage The MariaDB Docker image.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param environment Environment variables for MariaDB.
         * 
         * @return builder
         * 
         */
        ...
        public MariaDBArgs build() {
            if ($.databaseName == null) {
                throw new MissingRequiredPropertyException("MariaDBArgs", "databaseName");
            }
            if ($.databasePassword == null) {
                throw new MissingRequiredPropertyException("MariaDBArgs", "databasePassword");
            }
            if ($.databaseUser == null) {
                throw new MissingRequiredPropertyException("MariaDBArgs", "databaseUser");
            }
            $.dockerImage = Codegen.stringProp("dockerImage").output().arg($.dockerImage).def("mariadb:11").getNullable();
            if ($.environmentId == null) {
                throw new MissingRequiredPropertyException("MariaDBArgs", "environmentId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("MariaDBArgs", "name");
            }
            return $;
        }
    }
