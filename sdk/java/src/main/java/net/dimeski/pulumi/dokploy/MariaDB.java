...
public class MariaDB extends com.pulumi.resources.CustomResource {
     ...
     */
    public MariaDB(java.lang.String name) {
        this(name, MariaDBArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MariaDB(java.lang.String name, MariaDBArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MariaDB(java.lang.String name, MariaDBArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dokploy:index:MariaDB", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MariaDB(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("dokploy:index:MariaDB", name, null, makeResourceOptions(options, id), false);
    }

    private static MariaDBArgs makeArgs(MariaDBArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MariaDBArgs.Empty : args;
    }
     ...
     */
    public static MariaDB get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
