...
namespace Gjorgjidimeski.Dokploy
{
    ...
    /// A Dokploy project.
    /// </summary>
    [DokployResourceType("dokploy:index:Project")]
    public partial class Project : global::Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("dokploy:index:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("dokploy:index:Project", name, null, MakeResourceOptions(options, id))
        {
        }
