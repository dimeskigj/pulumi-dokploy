...
namespace Dimeskigj.Pulumi.Dokploy
{
    ...
    /// </summary>
    [DokployResourceType("dokploy:index:Tag")]
    public partial class Tag : global::Pulumi.CustomResource
    {
        ...
        public Tag(string name, TagArgs args, CustomResourceOptions? options = null)
            : base("dokploy:index:Tag", name, args ?? new TagArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Tag(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("dokploy:index:Tag", name, null, MakeResourceOptions(options, id))
        {
        }
