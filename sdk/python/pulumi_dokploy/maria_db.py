...
class MariaDBArgs:
    def __init__(__self__, *,
                 ...
                 database_root_password: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] database_name: The MariaDB database name.
        :param pulumi.Input[_builtins.str] database_password: The MariaDB database password.
        :param pulumi.Input[_builtins.str] database_user: The MariaDB database user.
        ...
        :param pulumi.Input[_builtins.str] database_root_password: The optional MariaDB root password.
        :param pulumi.Input[_builtins.str] description: An optional database description.
        :param pulumi.Input[_builtins.str] docker_image: The MariaDB Docker image.
        :param pulumi.Input[_builtins.str] environment: Environment variables for MariaDB.
        ...
        if database_root_password is not None:
            pulumi.set(__self__, "database_root_password", database_root_password)
    ...
    @_builtins.property
    @pulumi.getter(name="databaseRootPassword")
    def database_root_password(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The optional MariaDB root password.
        """
        return pulumi.get(self, "database_root_password")

    @database_root_password.setter
    def database_root_password(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "database_root_password", value)
...
@pulumi.type_token("dokploy:index:MariaDB")
class MariaDB(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param MariaDBArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MariaDBArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MariaDBArgs.__new__(MariaDBArgs)
            ...
            __props__.__dict__["database_root_password"] = None if database_root_password is None else pulumi.Output.secret(database_root_password)
        ...
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["databasePassword", "databaseRootPassword", "environment"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["environmentId", "serverId"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(MariaDB, __self__).__init__(
            'dokploy:index:MariaDB',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'MariaDB':
        """
        ...
        __props__.__dict__["database_root_password"] = None
        ...
        __props__.__dict__["status"] = None
        return MariaDB(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="databaseRootPassword")
    def database_root_password(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The optional MariaDB root password.
        """
        return pulumi.get(self, "database_root_password")
    ...
    def mariadb_id(self) -> pulumi.Output[_builtins.str]:
        """
