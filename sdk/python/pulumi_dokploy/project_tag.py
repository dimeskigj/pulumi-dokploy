...
class ProjectTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project_id: The Dokploy project ID.
        :param pulumi.Input[_builtins.str] tag_id: The Dokploy tag ID.
        """
...
@pulumi.type_token("dokploy:index:ProjectTag")
class ProjectTag(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        replace_on_changes = pulumi.ResourceOptions(replace_on_changes=["projectId", "tagId"])
        opts = pulumi.ResourceOptions.merge(opts, replace_on_changes)
        super(ProjectTag, __self__).__init__(
            'dokploy:index:ProjectTag',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ProjectTag':
        """
