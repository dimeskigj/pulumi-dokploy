...
class MySQLArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] database_name: The MySQL database name.
        :param pulumi.Input[_builtins.str] database_password: The MySQL database password.
        :param pulumi.Input[_builtins.str] database_user: The MySQL database user.
        ...
        :param pulumi.Input[_builtins.str] database_root_password: The optional MySQL root password.
        :param pulumi.Input[_builtins.str] description: An optional database description.
        :param pulumi.Input[_builtins.str] docker_image: The MySQL Docker image.
        :param pulumi.Input[_builtins.str] environment: Environment variables for MySQL.
...
@pulumi.type_token("dokploy:index:MySQL")
